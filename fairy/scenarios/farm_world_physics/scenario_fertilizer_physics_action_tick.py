...
@register_scenario("scenario_farm_world_fertilizer_physics_action_tick")
class ScenarioFarmWorldFertilizerPhysicsActionTick(Scenario):
    """
    ...
    expects_agent_harvest: bool = False  # mid-season fertigation only
    ...
    def _gates(self) -> list[GateSpec]:
        return [
            GateSpec(
                ...
                intent="agent observes ridges with low nutrient",
                window_days=(0.0, 1.0),
                eligible_tools=[
