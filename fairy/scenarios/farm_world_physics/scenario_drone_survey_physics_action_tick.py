...
@register_scenario("scenario_farm_world_drone_survey_physics_action_tick")
class ScenarioFarmWorldDroneSurveyPhysicsActionTick(Scenario):
    """
    ...
    def _gates(self) -> list[GateSpec]:
        return [
            ...
            GateSpec(
                ...
                intent="agent verifies flyable weather",
                window_days=(0.0, 1.0),
                eligible_tools=[("WeatherApp", "get_current_weather")],
            ),
            GateSpec(
                name="G3_fly_survey",
                intent="execute drone survey",
                window_days=(0.0, 1.0),
