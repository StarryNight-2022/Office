...
@register_scenario("scenario_farm_world_pesticide_physics_action_tick")
class ScenarioFarmWorldPesticidePhysicsActionTick(Scenario):
    """
    ...
    def _gates(self) -> list[GateSpec]:
        return [
            GateSpec(
                ...
                intent="agent observes pest pressure",
                window_days=(0.0, 1.0),
                eligible_tools=[
                    ("Mavic3M", "fly_survey"),
                    ("SensorApp", "read_canopy_sensors"),
                    ("Robot0", "inspect_pests"),
                ],
            ),
            GateSpec(
                name="G2_load_pesticide",
                intent="load pesticide before spray",
                window_days=(0.0, 1.0),
                eligible_tools=[
            ...
            GateSpec(
                name="G3_spray",
                intent="apply pesticide to affected ridges",
                window_days=(0.0, 1.0),
                eligible_tools=[
