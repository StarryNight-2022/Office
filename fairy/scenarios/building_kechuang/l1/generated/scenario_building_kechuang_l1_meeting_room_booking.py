...
CONTRACT = load_contract("scenario_building_kechuang_l1_meeting_room_booking")


@register_scenario("scenario_building_kechuang_l1_meeting_room_booking")
class ScenarioBuildingKechuangL1MeetingRoomBooking(ManifestDrivenBuildingL1Scenario):
    contract_id = "scenario_building_kechuang_l1_meeting_room_booking"
