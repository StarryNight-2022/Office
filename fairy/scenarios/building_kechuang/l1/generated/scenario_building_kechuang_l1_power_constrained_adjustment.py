...
CONTRACT = load_contract("scenario_building_kechuang_l1_power_constrained_adjustment")


@register_scenario("scenario_building_kechuang_l1_power_constrained_adjustment")
class ScenarioBuildingKechuangL1PowerConstrainedAdjustment(ManifestDrivenBuildingL1Scenario):
    contract_id = "scenario_building_kechuang_l1_power_constrained_adjustment"
