...
CONTRACT = load_contract("scenario_building_kechuang_l1_projector_control")


@register_scenario("scenario_building_kechuang_l1_projector_control")
class ScenarioBuildingKechuangL1ProjectorControl(ManifestDrivenBuildingL1Scenario):
    contract_id = "scenario_building_kechuang_l1_projector_control"
