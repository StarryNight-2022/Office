...
CONTRACT = load_contract("scenario_building_kechuang_l1_lighting_control")


@register_scenario("scenario_building_kechuang_l1_lighting_control")
class ScenarioBuildingKechuangL1LightingControl(ManifestDrivenBuildingL1Scenario):
    contract_id = "scenario_building_kechuang_l1_lighting_control"
