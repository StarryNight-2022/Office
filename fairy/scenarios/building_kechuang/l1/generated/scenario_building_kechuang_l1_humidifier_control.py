...
CONTRACT = load_contract("scenario_building_kechuang_l1_humidifier_control")


@register_scenario("scenario_building_kechuang_l1_humidifier_control")
class ScenarioBuildingKechuangL1HumidifierControl(ManifestDrivenBuildingL1Scenario):
    contract_id = "scenario_building_kechuang_l1_humidifier_control"
