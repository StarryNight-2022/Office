...
CONTRACT = load_contract("scenario_building_kechuang_l1_air_purifier_control")


@register_scenario("scenario_building_kechuang_l1_air_purifier_control")
class ScenarioBuildingKechuangL1AirPurifierControl(ManifestDrivenBuildingL1Scenario):
    contract_id = "scenario_building_kechuang_l1_air_purifier_control"
