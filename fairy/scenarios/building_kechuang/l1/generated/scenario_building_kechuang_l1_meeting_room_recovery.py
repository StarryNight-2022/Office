...
CONTRACT = load_contract("scenario_building_kechuang_l1_meeting_room_recovery")


@register_scenario("scenario_building_kechuang_l1_meeting_room_recovery")
class ScenarioBuildingKechuangL1MeetingRoomRecovery(ManifestDrivenBuildingL1Scenario):
    contract_id = "scenario_building_kechuang_l1_meeting_room_recovery"
