...
CONTRACT = load_contract("scenario_building_kechuang_l1_printer_control")


@register_scenario("scenario_building_kechuang_l1_printer_control")
class ScenarioBuildingKechuangL1PrinterControl(ManifestDrivenBuildingL1Scenario):
    contract_id = "scenario_building_kechuang_l1_printer_control"
