...
SPEC = get_spec("hb_heihe43_early_density_weed_nutrient_recovery")
...
class ScenarioFullSeasonHBHeihe43EarlyDensityWeedNutrientRecovery(Scenario):
    """Harbin HEIHE43 early density, weed, and nutrient recovery scenario."""
