...
SPEC = get_spec("hb_three_cultivar_wet_disease_dry_harvest_sequence")
...
class ScenarioFullSeasonHBThreeCultivarWetDiseaseDryHarvestSequence(Scenario):
    """Harbin three-cultivar wet-disease, dry-period, and harvest sequence."""
