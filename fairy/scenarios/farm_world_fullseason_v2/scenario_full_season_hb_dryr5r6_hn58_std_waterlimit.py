...
R1_FERTIGATION_CARRIER_WATER_MM = 0.5
...
class ScenarioFullSeasonHBDryR5R6HN58StdWaterLimit(Scenario):
    ...
    def init_and_populate_apps(self, *args: Any, **kwargs: Any) -> None:
        ...
        farm_world.configure_management_regime(
            regime="water_constrained",
    ...
    def build_events_flow(self) -> None:
        ...
        with EventRegisterer.capture_mode():
            ...
            o_detach_grader = (
                ...
                .oracle()
                .with_id("o_detach_grader_after_leveling")
                .depends_on(o_level, delay_seconds=1)
            )
            o_load_base = (
                tractor.load_fertilizer(240.0)
                .oracle()
            ...
            o_attach_furrower = (
                ...
                .oracle()
                .with_id("o_attach_furrower_before_ridging")
            ...
            o_detach_furrower = (
                tractor.detach_implement()
                .oracle()
                .with_id("o_detach_furrower_after_ridging")
            ...
            o_wait_emergence = advance_days(
                self, o_commit_plant, 15, "o_wait_emergence"
            )
            o_emergence_soil = (
                sensor.read_soil_sensors()
                .oracle()
                .with_id("o_emergence_soil_sensor_check")
                .depends_on(o_wait_emergence, delay_seconds=1)
            )
            o_emergence_canopy = (
                sensor.read_canopy_sensors()
                .oracle()
                .with_id("o_emergence_canopy_sensor_check")
            ...
            o_emergence_ground = (
                ...
                .oracle()
                .with_id("o_whole_field_emergence_ground_check")
            ...
            o_charge_robot_after_emergence = (
                ...
                .depends_on(o_emergence_ground, delay_seconds=1)
            )
            o_wait_robot_after_emergence = (
                system.advance_time(hours=1)
                .oracle()
                .with_id("o_wait_robot_charge_after_emergence_check")
                .depends_on(o_charge_robot_after_emergence, delay_seconds=1)
            )

            o_wait_early = advance_days(
                self, o_wait_robot_after_emergence, 24, "o_wait_early_growth"
            )
            o_early_soil = (
                sensor.read_soil_sensors()
                .oracle()
            ...
            o_early_canopy = (
                sensor.read_canopy_sensors()
                .oracle()
                .with_id("o_early_canopy_check")
                .depends_on(o_early_soil, delay_seconds=1)
            )
            o_robot_status_early = (
                robot.check_status()
                .oracle()
                .with_id("o_robot_status_before_early_health")
                .depends_on(o_early_canopy, delay_seconds=1)
            )
            o_early_health = (
                robot.inspect_crop_health(0, 63)
                .oracle()
                .with_id("o_early_whole_field_health_check")
                .depends_on(o_robot_status_early, delay_seconds=2)
            )
            o_charge_robot_after_early = (
                robot.charge()
                .oracle()
                .with_id("o_charge_robot_after_early_health")
                .depends_on(o_early_health, delay_seconds=1)
            )
            o_wait_robot_after_early = (
                system.advance_time(hours=1)
                .oracle()
                .with_id("o_wait_robot_charge_after_early_health")
                .depends_on(o_charge_robot_after_early, delay_seconds=1)
            )

            o_wait_r1 = advance_days(
                self, o_wait_robot_after_early, 21, "o_wait_r1_nutrient_window"
            )
            o_r1_soil = (
                sensor.read_soil_sensors()
                .oracle()
            ...
            o_r1_canopy = (
                sensor.read_canopy_sensors()
                .oracle()
                .with_id("o_r1_canopy_nutrient_check")
                .depends_on(o_r1_soil, delay_seconds=1)
            )
            o_robot_status_r1 = (
                robot.check_status()
                .oracle()
                .with_id("o_robot_status_before_r1_health")
                .depends_on(o_r1_canopy, delay_seconds=1)
            )
            o_r1_health = (
                robot.inspect_crop_health(0, 63)
                .oracle()
                .with_id("o_r1_whole_field_health_check")
            ...
            o_r1_topdress = (
                farm_world.apply_fertigation(
                    0,
                    63,
                    nutrient_amount=R1_NUTRIENT_AMOUNT,
                    water_mm=R1_FERTIGATION_CARRIER_WATER_MM,
                )
                .oracle()
            ...
            o_charge_robot_after_r1 = (
                robot.charge()
                .oracle()
                .with_id("o_charge_robot_after_r1_health")
                .depends_on(o_commit_r1, delay_seconds=1)
            )
            o_wait_robot_after_r1 = (
                system.advance_time(hours=1)
                .oracle()
                .with_id("o_wait_robot_charge_after_r1_health")
                .depends_on(o_charge_robot_after_r1, delay_seconds=1)
            )

            o_wait_mid = advance_days(
                self, o_wait_robot_after_r1, 17, "o_wait_midseason_scout"
            )
            o_mid_weather = (
                weather.get_current_weather()
                .oracle()
            ...
            o_mid_soil = (
                sensor.read_soil_sensors()
                .oracle()
                .with_id("o_midseason_soil_check")
                .depends_on(o_mid_weather, delay_seconds=1)
            )
            o_mid_canopy = (
                sensor.read_canopy_sensors()
                .oracle()
                .with_id("o_midseason_canopy_check")
            ...
            o_mid_robot_status = (
                ...
                .depends_on(o_mid_canopy, delay_seconds=1)
            )
            o_mid_pests = (
                robot.inspect_pests(0, 63)
                .oracle()
                .with_id("o_midseason_whole_field_pest_check")
                .depends_on(o_mid_robot_status, delay_seconds=2)
            )
            o_charge_robot_after_mid = (
                robot.charge()
                .oracle()
                .with_id("o_charge_robot_after_midseason_pest_check")
                .depends_on(o_mid_pests, delay_seconds=1)
            )
            o_wait_robot_after_mid = (
                system.advance_time(hours=1)
                .oracle()
                .with_id("o_wait_robot_charge_after_midseason_pest_check")
                .depends_on(o_charge_robot_after_mid, delay_seconds=1)
            )

            o_wait_r5 = advance_days(
                self, o_wait_robot_after_mid, 27, "o_wait_r5_r6_drought_window"
            )
            o_r5_weather = (
                weather.get_current_weather()
                .oracle()
            ...
            o_r5_forecast = (
                ...
                .depends_on(o_r5_weather, delay_seconds=1)
            )
            o_r5_soil = (
                sensor.read_soil_sensors()
                .oracle()
                .with_id("o_r5_r6_soil_water_check")
                .depends_on(o_r5_forecast, delay_seconds=1)
            )
            o_r5_canopy = (
                sensor.read_canopy_sensors()
                .oracle()
                .with_id("o_r5_r6_canopy_sensor_check")
                .depends_on(o_r5_soil, delay_seconds=1)
            )
            o_priority_ndvi = (
                mavic.fly_survey(PRIORITY_START, PRIORITY_END)
                .oracle()
                .with_id("o_sensor_flagged_priority_r5_r6_ndvi")
                .depends_on(o_r5_canopy, delay_seconds=2)
            )
            o_west_reference_ndvi = (
                mavic.fly_survey(REFERENCE_WEST_START, REFERENCE_WEST_END)
                .oracle()
                .with_id("o_west_reference_r5_r6_ndvi")
                .depends_on(o_priority_ndvi, delay_seconds=2)
            )
            o_east_reference_ndvi = (
                mavic.fly_survey(REFERENCE_EAST_START, REFERENCE_EAST_END)
                .oracle()
                .with_id("o_east_reference_r5_r6_ndvi")
                .depends_on(o_west_reference_ndvi, delay_seconds=2)
            )
            o_priority_thermal = (
                matrice.fly_survey(PRIORITY_START, PRIORITY_END)
                .oracle()
                .with_id("o_sensor_flagged_priority_r5_r6_thermal")
                .depends_on(o_east_reference_ndvi, delay_seconds=2)
            )
            o_robot_status_drought = (
                robot.check_status()
                .oracle()
                .with_id("o_robot_status_before_priority_water_check")
                .depends_on(o_priority_thermal, delay_seconds=1)
            )
            o_priority_health = (
                robot.inspect_crop_health(PRIORITY_START, PRIORITY_END)
                .oracle()
                .with_id("o_priority_r5_r6_health_check")
                .depends_on(o_robot_status_drought, delay_seconds=2)
            )
            o_charge_robot_before_priority_pests = (
                robot.charge()
                .oracle()
                .with_id("o_charge_robot_before_priority_pest_ruleout")
                .depends_on(o_priority_health, delay_seconds=1)
            )
            o_wait_robot_before_priority_pests = (
                system.advance_time(hours=1)
                .oracle()
                .with_id("o_wait_robot_charge_before_priority_pest_ruleout")
                .depends_on(o_charge_robot_before_priority_pests, delay_seconds=1)
            )
            o_robot_status_priority_pests = (
                robot.check_status()
                .oracle()
                .with_id("o_robot_status_before_priority_pest_ruleout")
                .depends_on(o_wait_robot_before_priority_pests, delay_seconds=1)
            )
            o_priority_pests = (
                robot.inspect_pests(PRIORITY_START, PRIORITY_END)
                .oracle()
                .with_id("o_priority_r5_r6_rule_out_pests")
                .depends_on(o_robot_status_priority_pests, delay_seconds=2)
            )
            o_irrigate = (
                field_ops.irrigate(
                    PRIORITY_START, PRIORITY_END, hours=R5_IRRIGATION_HOURS
                )
                .oracle()
                .with_id("o_limited_water_targeted_irrigation_22_43")
                .depends_on(o_priority_pests, delay_seconds=2)
            )
            o_wait_response = (
                system.advance_time(hours=6)
                .oracle()
                .with_id("o_wait_limited_irrigation_response")
                .depends_on(o_irrigate, delay_seconds=1)
            )
            o_recheck_soil = (
                sensor.read_soil_sensors()
                .oracle()
                .with_id("o_limited_irrigation_soil_recheck")
                .depends_on(o_wait_response, delay_seconds=1)
            )
            o_recheck_thermal = (
                matrice.fly_survey(PRIORITY_START, PRIORITY_END)
                .oracle()
                .with_id("o_limited_irrigation_thermal_recheck")
                .depends_on(o_recheck_soil, delay_seconds=2)
            )
            o_commit_irrigation = (
                farm_world.commit_daily_physics()
                .oracle()
                .with_id("o_commit_limited_irrigation_management")
            ...
            o_harvest_weather = (
                ...
                .depends_on(o_wait_harvest, delay_seconds=1)
            )
            o_harvest_forecast = (
                weather.get_forecast(days=3)
                .oracle()
            ...
            o_attach = (
                ...
                .depends_on(o_harvest_range, delay_seconds=1)
            )
            ...
            o_post_storage = advance_days(
                self, o_after_harvest, 1, "o_wait_post_storage_stability"
            )
            _ = (
                aui.send_message_to_user(
                    content="已完成黑农58 R5/R6干旱有限灌溉场景：仅对工具确认的高风险22-43垄灌溉，并完成收获入库。"
                )
                .oracle()
                .with_id("o_report")
                .depends_on(o_post_storage, delay_seconds=2)
            )
