...
SPEC = get_spec("hb_heinong58_resistant_biotic_water_budget_priority")
...
class ScenarioFullSeasonHBHeinong58ResistantBioticWaterBudgetPriority(Scenario):
    """Harbin HEINONG84/HEINONG58 biotic and water-budget priority scenario."""
