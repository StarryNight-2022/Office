...
SPEC = get_spec("hb_hn84_hn58_low_chemical_disease_insect_budget")
...
class ScenarioFullSeasonHBHn84Hn58LowChemicalDiseaseInsectBudget(Scenario):
    """Harbin HN84/HN58 low-chemical disease and insect budget scenario."""
