...
SCENARIO_ID = 'scenario_l2_hb_lowcarbon_wetdisease_mid_fungicide_24_47'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbLowcarbonWetdiseaseMidFungicide2447(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        build_management_l2_flow(self, SPEC, SPEC.actions[0], 'o_mid_fungicide_24_47', briefing_text)

    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_lowcarbon_batch_operations_wetdisease mid_fungicide_24_47 L2')
