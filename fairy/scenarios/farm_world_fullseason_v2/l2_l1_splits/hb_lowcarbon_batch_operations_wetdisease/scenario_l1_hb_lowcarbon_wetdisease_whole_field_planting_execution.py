...
SCENARIO_ID = 'scenario_l1_hb_lowcarbon_wetdisease_whole_field_planting_execution'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbLowcarbonWetdiseaseWholeFieldPlantingExecution(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_lowcarbon_batch_operations_wetdisease planting L1')
