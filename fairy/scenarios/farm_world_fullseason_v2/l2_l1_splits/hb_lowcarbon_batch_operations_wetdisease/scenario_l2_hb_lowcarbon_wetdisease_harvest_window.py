...
SCENARIO_ID = 'scenario_l2_hb_lowcarbon_wetdisease_harvest_window'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbLowcarbonWetdiseaseHarvestWindow(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        build_harvest_l2_flow(self, SPEC, 35, briefing_text)

    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_lowcarbon_batch_operations_wetdisease harvest L2')
