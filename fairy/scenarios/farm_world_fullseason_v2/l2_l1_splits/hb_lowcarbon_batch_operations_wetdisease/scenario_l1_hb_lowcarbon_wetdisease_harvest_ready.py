...
SCENARIO_ID = 'scenario_l1_hb_lowcarbon_wetdisease_harvest_ready'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbLowcarbonWetdiseaseHarvestReady(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_lowcarbon_batch_operations_wetdisease harvest L1')
