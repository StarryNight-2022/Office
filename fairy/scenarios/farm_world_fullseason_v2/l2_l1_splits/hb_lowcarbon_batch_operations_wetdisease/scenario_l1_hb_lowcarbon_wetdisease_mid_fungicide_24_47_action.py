...
CHECKPOINT_LABEL = 'before_o_mid_fungicide_0_24_47_action'
SPEC = get_spec(SPEC_SLUG)
SCENARIO_ID = 'scenario_l1_hb_lowcarbon_wetdisease_mid_fungicide_24_47_action'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbLowcarbonWetdiseaseMidFungicide2447Action(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        build_management_l1_flow(self, SPEC, SPEC.actions[0], 'o_mid_fungicide_24_47', briefing_text)

    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_lowcarbon_batch_operations_wetdisease mid_fungicide_24_47 L1')
