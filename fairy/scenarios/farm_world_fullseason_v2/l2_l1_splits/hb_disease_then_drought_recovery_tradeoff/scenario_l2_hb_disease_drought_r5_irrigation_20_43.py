...
SCENARIO_ID = 'scenario_l2_hb_disease_drought_r5_irrigation_20_43'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbDiseaseDroughtR5Irrigation2043(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        build_management_l2_flow(self, SPEC, SPEC.actions[1], 'o_r5_irrigation_20_43', briefing_text)

    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_disease_then_drought_recovery_tradeoff r5_irrigation_20_43 L2')
