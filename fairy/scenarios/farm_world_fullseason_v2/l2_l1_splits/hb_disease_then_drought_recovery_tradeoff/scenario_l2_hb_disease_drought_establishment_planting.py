...
SCENARIO_ID = 'scenario_l2_hb_disease_drought_establishment_planting'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbDiseaseDroughtEstablishmentPlanting(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_disease_then_drought_recovery_tradeoff establishment planting L2')
