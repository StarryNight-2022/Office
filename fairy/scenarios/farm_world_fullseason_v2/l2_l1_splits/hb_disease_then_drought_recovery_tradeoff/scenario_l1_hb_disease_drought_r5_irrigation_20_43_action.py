...
CHECKPOINT_LABEL = 'before_o_r5_irrigation_0_20_43_action'
SPEC = get_spec(SPEC_SLUG)
SCENARIO_ID = 'scenario_l1_hb_disease_drought_r5_irrigation_20_43_action'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbDiseaseDroughtR5Irrigation2043Action(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        build_management_l1_flow(self, SPEC, SPEC.actions[1], 'o_r5_irrigation_20_43', briefing_text)

    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_disease_then_drought_recovery_tradeoff r5_irrigation_20_43 L1')
