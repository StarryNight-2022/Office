...
SCENARIO_ID = 'scenario_l1_hb_disease_drought_whole_field_planting_execution'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbDiseaseDroughtWholeFieldPlantingExecution(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_disease_then_drought_recovery_tradeoff planting L1')
