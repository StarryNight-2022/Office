...
SCENARIO_ID = 'scenario_l2_hb_skip_rows_harvest_window'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbSkipRowsHarvestWindow(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_planter_skip_rows_stand_gap harvest L2')
