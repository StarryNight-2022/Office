...
SCENARIO_ID = 'scenario_l2_hb_weed_seedbank_establishment_planting'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbWeedSeedbankEstablishmentPlanting(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_high_weed_seedbank_mechanical_only_baseline establishment planting L2')
