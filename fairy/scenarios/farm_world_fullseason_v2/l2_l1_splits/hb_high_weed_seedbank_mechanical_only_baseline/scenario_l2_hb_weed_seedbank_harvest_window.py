...
SCENARIO_ID = 'scenario_l2_hb_weed_seedbank_harvest_window'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbWeedSeedbankHarvestWindow(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        build_harvest_l2_flow(self, SPEC, 39, briefing_text)

    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_high_weed_seedbank_mechanical_only_baseline harvest L2')
