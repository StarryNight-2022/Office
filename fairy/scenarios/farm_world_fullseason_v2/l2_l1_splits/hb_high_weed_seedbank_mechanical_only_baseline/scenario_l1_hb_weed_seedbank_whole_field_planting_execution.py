...
SCENARIO_ID = 'scenario_l1_hb_weed_seedbank_whole_field_planting_execution'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbWeedSeedbankWholeFieldPlantingExecution(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_high_weed_seedbank_mechanical_only_baseline planting L1')
