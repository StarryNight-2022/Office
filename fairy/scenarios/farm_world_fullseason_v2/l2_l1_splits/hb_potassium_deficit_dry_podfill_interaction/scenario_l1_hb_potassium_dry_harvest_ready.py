...
CHECKPOINT_LABEL = 'o_wait_harvest_day_024'
SPEC = get_spec(SPEC_SLUG)
SCENARIO_ID = 'scenario_l1_hb_potassium_dry_harvest_ready'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbPotassiumDryHarvestReady(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_potassium_deficit_dry_podfill_interaction harvest L1')
