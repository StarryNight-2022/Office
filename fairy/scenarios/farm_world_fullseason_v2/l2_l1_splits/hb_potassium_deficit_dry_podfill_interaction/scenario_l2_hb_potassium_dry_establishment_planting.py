...
SCENARIO_ID = 'scenario_l2_hb_potassium_dry_establishment_planting'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbPotassiumDryEstablishmentPlanting(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_potassium_deficit_dry_podfill_interaction establishment planting L2')
