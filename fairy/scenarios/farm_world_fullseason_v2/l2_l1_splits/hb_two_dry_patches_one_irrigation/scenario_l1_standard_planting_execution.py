...
from fairy.apps.farm_world import TractorApp
...
SCENARIO_ID = "scenario_l1_hb_two_dry_patches_planting_execution"
CHECKPOINT_DIR = Path(__file__).resolve().parent / "checkpoints"
CHECKPOINT_LABEL = "before_whole_field_planting_action"


@register_scenario(SCENARIO_ID)
class ScenarioL1HBTwoDryPatchesPlantingExecution(Scenario):
    ...
    def build_events_flow(self) -> None:
        briefing = (
            "整地、底肥和起垄已完成。请重新检查天气、预报、播床土壤和播种机状态后，"
            "装载HEINONG84种子，按4垄一趟播种0-63垄，播深4.0 cm、seed_spacing_cm=7.9，并提交物理更新。"
        ...
        self.events = build_planting_l1_events(
            ...
            report_text="已完成两旱斑场景的全田播种执行。",
            prefix="o_two_dry_planting",
        )

    def validate(self, env):
        return validate_native_workflow(self, env, "two dry patches planting L1 split")
