...
SCENARIO_ID = 'scenario_l1_hb_laterain_insect_whole_field_planting_execution'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbLaterainInsectWholeFieldPlantingExecution(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_laterain_insect_risk planting L1')
