...
SCENARIO_ID = 'scenario_l2_hb_laterain_insect_establishment_planting'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbLaterainInsectEstablishmentPlanting(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_laterain_insect_risk establishment planting L2')
