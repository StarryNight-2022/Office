...
SCENARIO_ID = 'scenario_l2_hb_r5_leaf_feeder_harvest_window'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbR5LeafFeederHarvestWindow(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        build_harvest_l2_flow(self, SPEC, 36, briefing_text)

    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_r5_leaf_feeder_defoliation harvest L2')
