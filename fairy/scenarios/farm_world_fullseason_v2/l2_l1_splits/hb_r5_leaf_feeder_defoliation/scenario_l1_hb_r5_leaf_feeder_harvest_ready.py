...
CHECKPOINT_LABEL = 'o_wait_harvest_day_037'
SPEC = get_spec(SPEC_SLUG)
SCENARIO_ID = 'scenario_l1_hb_r5_leaf_feeder_harvest_ready'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbR5LeafFeederHarvestReady(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_r5_leaf_feeder_defoliation harvest L1')
