...
SCENARIO_ID = 'scenario_l2_hb_r5_leaf_feeder_establishment_planting'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbR5LeafFeederEstablishmentPlanting(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_r5_leaf_feeder_defoliation establishment planting L2')
