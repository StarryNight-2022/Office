...
SCENARIO_ID = 'scenario_l1_hb_r5_leaf_feeder_whole_field_planting_execution'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbR5LeafFeederWholeFieldPlantingExecution(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_r5_leaf_feeder_defoliation planting L1')
