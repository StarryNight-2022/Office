...
SCENARIO_ID = "scenario_l2_hb_wetjune_shortwindow_standard_planting"
CHECKPOINT_DIR = Path(__file__).resolve().parent / "checkpoints"
CHECKPOINT_LABEL = "initial_before_field_prep"


@register_scenario(SCENARIO_ID)
class ScenarioL2HBWetjuneShortwindowStandardPlanting(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        self.events = build_preplant_l2_events(
            ...
            report_text="已完成湿六月短窗口场景的播前准备和全田播种。",
            prefix="o_wetjune_preplant",
        )

    def validate(self, env):
        return validate_native_workflow(self, env, "wetjune shortwindow planting L2 split")
