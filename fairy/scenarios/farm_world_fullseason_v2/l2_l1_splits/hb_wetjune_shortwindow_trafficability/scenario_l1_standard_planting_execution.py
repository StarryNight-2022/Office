...
SCENARIO_ID = "scenario_l1_hb_wetjune_shortwindow_planting_execution"
CHECKPOINT_DIR = Path(__file__).resolve().parent / "checkpoints"
CHECKPOINT_LABEL = "before_whole_field_planting_action"


@register_scenario(SCENARIO_ID)
class ScenarioL1HBWetjuneShortwindowPlantingExecution(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        self.events = build_planting_l1_events(
            ...
            report_text="已完成湿六月短窗口场景的全田播种执行。",
            prefix="o_wetjune_planting",
        )

    def validate(self, env):
        return validate_native_workflow(self, env, "wetjune shortwindow planting L1 split")
