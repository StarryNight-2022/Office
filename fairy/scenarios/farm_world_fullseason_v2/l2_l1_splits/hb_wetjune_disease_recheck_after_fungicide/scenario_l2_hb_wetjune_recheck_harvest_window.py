...
SCENARIO_ID = 'scenario_l2_hb_wetjune_recheck_harvest_window'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbWetjuneRecheckHarvestWindow(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        build_harvest_l2_flow(self, SPEC, 34, briefing_text)

    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_wetjune_disease_recheck_after_fungicide harvest L2')
