...
SCENARIO_ID = 'scenario_l2_hb_wetjune_recheck_mid_fungicide_20_43'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbWetjuneRecheckMidFungicide2043(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_wetjune_disease_recheck_after_fungicide mid_fungicide_20_43 L2')
