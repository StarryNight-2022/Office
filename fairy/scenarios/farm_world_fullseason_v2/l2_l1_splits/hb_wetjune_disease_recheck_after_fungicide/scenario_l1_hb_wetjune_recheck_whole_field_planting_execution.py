...
SCENARIO_ID = 'scenario_l1_hb_wetjune_recheck_whole_field_planting_execution'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbWetjuneRecheckWholeFieldPlantingExecution(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_wetjune_disease_recheck_after_fungicide planting L1')
