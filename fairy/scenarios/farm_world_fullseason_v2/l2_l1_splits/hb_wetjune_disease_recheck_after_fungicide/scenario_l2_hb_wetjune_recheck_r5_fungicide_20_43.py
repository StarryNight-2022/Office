...
SCENARIO_ID = 'scenario_l2_hb_wetjune_recheck_r5_fungicide_20_43'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbWetjuneRecheckR5Fungicide2043(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        build_management_l2_flow(self, SPEC, SPEC.actions[1], 'o_r5_fungicide_20_43', briefing_text)

    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_wetjune_disease_recheck_after_fungicide r5_fungicide_20_43 L2')
