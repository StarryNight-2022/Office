...
SCENARIO_ID = 'scenario_l2_hb_wetjune_recheck_establishment_planting'


@register_scenario(SCENARIO_ID)
class ScenarioL2HbWetjuneRecheckEstablishmentPlanting(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_wetjune_disease_recheck_after_fungicide establishment planting L2')
