...
CHECKPOINT_LABEL = 'o_wait_harvest_day_035'
SPEC = get_spec(SPEC_SLUG)
SCENARIO_ID = 'scenario_l1_hb_wetjune_recheck_harvest_ready'


@register_scenario(SCENARIO_ID)
class ScenarioL1HbWetjuneRecheckHarvestReady(Scenario):
    ...
    def validate(self, env) -> ScenarioValidationResult:
        return validate_native_workflow(self, env, 'hb_wetjune_disease_recheck_after_fungicide harvest L1')
