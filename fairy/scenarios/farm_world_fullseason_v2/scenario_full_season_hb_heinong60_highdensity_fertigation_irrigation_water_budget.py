...
SPEC = get_spec("hb_heinong60_highdensity_fertigation_irrigation_water_budget")
...
class ScenarioFullSeasonHBHeinong60HighdensityFertigationIrrigationWaterBudget(
    Scenario
):
    """Harbin HN60 high-density fertigation and irrigation shared water budget."""
