...
```text
fairy/scenarios/farm_world_fullseason_v2/scenario_<slug>.py
```
...
```bash
PYTHONPATH=. python scripts/run_scenario.py \
  -s <scenario_id> \
  --build-oracle --replay --evaluate \
  --output-dir /tmp/<scenario_id>_check
```
...
```text
fairy/scenarios/farm_world_fullseason_v2/fullseason_l3_scenario_descriptions_13_42.md
```
...
- Shared v2 helpers:
  `fairy/scenarios/farm_world_fullseason_v2/harbin_l3_scenario_helpers.py`
- Trace utilities:
